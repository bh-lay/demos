(function(){
	// <a href="http://github.com/tholman/github-corners" class="github-corner">
 //              <svg width="80" height="80" viewBox="0 0 250 250" style="position: absolute; top: 0px; right: 0px; border: 0px;background: #fafafa;box-shadow: -1px 1px 2px rgba(0,0,0,.4) , 0 0 2px #fff inset;">
